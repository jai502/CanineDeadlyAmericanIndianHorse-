...
public class TestEmail 
{
	...
	public static void main(String[] args) 
	{
		...
		String usrPassword = "Retrieve password here";	//should we be sending passwords in emails
    
		//HTML email message
		//Should this be in SendEmail class or stored in database/server to keep standard message each time
