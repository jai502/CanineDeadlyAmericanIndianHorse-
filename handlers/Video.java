...
public class Video{
	...
	private VideoItem videoToHandle;
	 ...
	 */
	public Video(VideoItem videoToHandle) {
		setVideoToHandle(videoToHandle);
	 ...
	 * @return 
	 */
	public void Audio(int startTime, int duration, String sourceFile, boolean loop) {
	...
	public VideoItem getVideoToHandle() {
		return videoToHandle;
	}

	public void setVideoToHandle(VideoItem videoToHandle) {
		this.videoToHandle = videoToHandle;
	}
