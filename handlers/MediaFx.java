...
public class MediaFx {
 ...
 player on screen.
	...
	public MediaFx(AudioItem audioToHandle) {
		this.startTime = audioToHandle.getStartTime();
		this.duration = audioToHandle.getDuration();
		this.sourceFile = audioToHandle.getSourceFile();
		this.loop = audioToHandle.isLoop();
